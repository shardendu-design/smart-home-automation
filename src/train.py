...
temp_model_save_path = "/media/shardendujha/backup11/Home_Automation/src/temp_random_forest_model.pkl"
humid_model_save_path = "/media/shardendujha/backup11/Home_Automation/src/humid_random_forest_model.pkl"
co2_model_save_path = "/media/shardendujha/backup11/Home_Automation/src/co2_random_forest_model.pkl"
voc_model_save_path = "/media/shardendujha/backup11/Home_Automation/src/voc_random_forest_model.pkl"
pm25_model_save_path = "/media/shardendujha/backup11/Home_Automation/src/pm25_random_forest_model.pkl"
...
def temp_pred_model():
    ...
    plt.tight_layout()
    plt.savefig('/media/shardendujha/backup11/Home_Automation/notebook/temp_model_performance.png')  # Save the plot as an image
...
def humid_pred_model():
    ...
    plt.tight_layout()
    plt.savefig('/media/shardendujha/backup11/Home_Automation/notebook/humid_model_performance.png')  # Save the plot as an image
    print("Plot saved as /media/shardendujha/backup11/Home_Automation/notebook/humid_model_performance.png")
...
def co2_pred_model():
    ...
    plt.tight_layout()
    plt.savefig('/media/shardendujha/backup11/Home_Automation/notebook/co2_model_performance.png')  # Save the plot as an image
    print("Plot saved as /media/shardendujha/backup11/Home_Automation/notebook/co2_model_performance.png")
...
def voc_pred_model():
    ...
    plt.tight_layout()
    plt.savefig('/media/shardendujha/backup11/Home_Automation/notebook/voc_model_performance.png')  # Save the plot as an image
    print("Plot saved as /media/shardendujha/backup11/Home_Automation/notebook/voc_model_performance.png")
...
def pm25_pred_model():
    ...
    plt.tight_layout()
    plt.savefig('/media/shardendujha/backup11/Home_Automation/notebook/pm25_model_performance.png')  # Save the plot as an image
    print("Plot saved as /media/shardendujha/backup11/Home_Automation/notebook/pm25_model_performance.png")
