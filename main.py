...
traind_models = "/media/shardendujha/backup11/traind_models_score/trained_models.csv"
...
def train_model():
    while True:
        ...
        csv_file = "/media/shardendujha/backup11/traind_models_score/trained_models.csv"
